...
#include "display/graphic/tft/ili9325/commands/GRAMStartWritingCmd.h"
#include "display/graphic/tft/ili9325/commands/EntryModeCmd.h"
    ...
    namespace display {
        ...
        class ILI9325Colour<COLOURS_18BIT,TAccessMode> {
            ...
            protected:
                ...
                uint16_t getColourEntryMode() const;
        ...
        template<class TAccessMode>
        inline ILI9325Colour<COLOURS_18BIT,TAccessMode>::ILI9325Colour(TAccessMode& accessMode)
        ...
        template<class TAccessMode>
        inline uint16_t ILI9325Colour<COLOURS_18BIT,TAccessMode>::getColourEntryMode() const {
            return ili9325::EntryModeCmd::DFM | ili9325::EntryModeCmd::TRI;
        }
