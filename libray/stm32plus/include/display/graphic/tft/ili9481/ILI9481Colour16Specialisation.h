...
namespace stm32plus {
    namespace display {
        ...
        class ILI9481Colour<COLOURS_16BIT,TAccessMode> {
        ...
        template<class TAccessMode>
        inline ILI9481Colour<COLOURS_16BIT,TAccessMode>::ILI9481Colour(TAccessMode& accessMode)
        ...
        template<class TAccessMode>
        inline uint16_t ILI9481Colour<COLOURS_16BIT,TAccessMode>::getPixelFormat() const {
            return ili9481::SetPixelFormatCmd::COLOURS_64K;
        }
     ...
     * 0000000000000000RRRRRGGGGGGBBBBB
        ...
        template<class TAccessMode>
        inline void ILI9481Colour<COLOURS_16BIT,TAccessMode>::unpackColour(tCOLOUR src,UnpackedColour& dest) const {
        ...
        template<class TAccessMode>
        inline void ILI9481Colour<COLOURS_16BIT,TAccessMode>::unpackColour(uint8_t red,uint8_t green,uint8_t blue,UnpackedColour& dest) const {
        ...
        template<class TAccessMode>
        inline void ILI9481Colour<COLOURS_16BIT,TAccessMode>::writePixel(const UnpackedColour& cr) const {
        ...
        template<class TAccessMode>
        inline void ILI9481Colour<COLOURS_16BIT,TAccessMode>::fillPixels(uint32_t numPixels,const UnpackedColour& cr) const {
        ...
        template<class TAccessMode>
        inline void ILI9481Colour<COLOURS_16BIT,TAccessMode>::allocatePixelBuffer(uint32_t numPixels,uint8_t*& buffer,uint32_t& bytesPerPixel) const {
        ...
        template<class TAccessMode>
        inline void ILI9481Colour<COLOURS_16BIT,TAccessMode>::rawTransfer(const void *buffer,uint32_t numPixels) const {
