...
namespace stm32plus {
    namespace display {
        ...
        class MC2PA8201Colour<COLOURS_24BIT,TAccessMode> {
        ...
        template<class TAccessMode>
        inline MC2PA8201Colour<COLOURS_24BIT,TAccessMode>::MC2PA8201Colour(TAccessMode& accessMode)
        ...
        template<class TAccessMode>
        inline uint16_t MC2PA8201Colour<COLOURS_24BIT,TAccessMode>::getInterfacePixelFormat() const {
            return 0x77;
        }
     ...
     * RRRRRRRR,GGGGGGGG,BBBBBBBB
        ...
        template<class TAccessMode>
        inline void MC2PA8201Colour<COLOURS_24BIT,TAccessMode>::unpackColour(tCOLOUR src,UnpackedColour& dest) const {
            dest.r=(src >> 16) & 0xff;
            dest.g=(src >> 8) & 0xff;
            dest.b=src & 0xff;
        }
        ...
        template<class TAccessMode>
        inline void MC2PA8201Colour<COLOURS_24BIT,TAccessMode>::unpackColour(uint8_t red,uint8_t green,uint8_t blue,UnpackedColour& dest) const {
            dest.r=red;
            dest.g=green;
            dest.b=blue;
        }
        ...
        template<class TAccessMode>
        inline void MC2PA8201Colour<COLOURS_24BIT,TAccessMode>::writePixel(const UnpackedColour& cr) const {
        ...
        template<class TAccessMode>
        inline void MC2PA8201Colour<COLOURS_24BIT,TAccessMode>::fillPixels(uint32_t numPixels,const UnpackedColour& cr) const {
        ...
        template<class TAccessMode>
        inline void MC2PA8201Colour<COLOURS_24BIT,TAccessMode>::allocatePixelBuffer(uint32_t numPixels,uint8_t*& buffer,uint32_t& bytesPerPixel) const {
        ...
        template<class TAccessMode>
        inline void MC2PA8201Colour<COLOURS_24BIT,TAccessMode>::rawTransfer(const void *buffer,uint32_t numPixels) const {
