...
namespace stm32plus {
    namespace display {
        ...
        class MC2PA8201Orientation<PORTRAIT,TAccessMode> {
        ...
        template<class TAccessMode>
        inline MC2PA8201Orientation<PORTRAIT,TAccessMode>::MC2PA8201Orientation(TAccessMode& accessMode)
        ...
        template<class TAccessMode>
        inline uint16_t MC2PA8201Orientation<PORTRAIT,TAccessMode>::getMemoryAccessControl() const {
            return 0xc8;
        }
        ...
        template<class TAccessMode>
        inline int16_t MC2PA8201Orientation<PORTRAIT,TAccessMode>::getWidth() const {
          return 240;
        }
        ...
        template<class TAccessMode>
        inline int16_t MC2PA8201Orientation<PORTRAIT,TAccessMode>::getHeight() const {
          return 320;
        }
        ...
        template<class TAccessMode>
        inline void MC2PA8201Orientation<PORTRAIT,TAccessMode>::moveTo(const Rectangle& rc) const {
        ...
        template<class TAccessMode>
        inline void MC2PA8201Orientation<PORTRAIT,TAccessMode>::setScrollPosition(int16_t scrollPosition) {
