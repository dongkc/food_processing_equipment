    ...
    namespace fat {
        ...
        class FatFileSystem : public FileSystem {
            ...
            public:
                ...
                virtual bool getFileInformation(const char *filename,FileInformation*& finfo);
                virtual bool getDirectoryIterator(const char *pathname,DirectoryIterator*& newIterator);
                virtual bool createFile(const char *filename);
                virtual bool openFile(const char *filename,File*& newFile);
                ...
                virtual uint32_t getSectorSizeInBytes() const;
                virtual bool getFreeSpace(uint32_t& freeUnits,uint32_t& unitsMultiplier);
                 ...
                 * when finished. NULL is returned on failure and the error provider is updated.
                 */
