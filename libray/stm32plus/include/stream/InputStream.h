...
namespace stm32plus {
    ...
    class InputStream {
        ...
        public:
             ...
             * range 0..255. If the read fails then the return value is StreamError.
            ...
            /**
             * Close the stream. If the stream implementation does not support closing
             * then it will return true and do nothing.
             *
