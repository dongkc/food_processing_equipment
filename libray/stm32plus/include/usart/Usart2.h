...
namespace stm32plus {
    ...
    /**
     * @brief Usart2 implementation
     */

    class Usart2 : public UsartPeripheral {

        public:
            /// The transmit pin
            static const uint16_t GPIO_Pin_TX=GPIO_Pin_2;

            /// The receive pin
            static const uint16_t GPIO_Pin_RX=GPIO_Pin_3;
