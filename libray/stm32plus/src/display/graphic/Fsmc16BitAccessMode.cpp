...
namespace stm32plus {
    namespace display {
        ...
        Fsmc16BitAccessMode::Fsmc16BitAccessMode(
                uint32_t bank,
            ...
            _dataAddress=static_cast<uint16_t *>(_baseAddress)+(1<<registerAddressLine);
            _registerAddress=static_cast<volatile uint16_t *>(_baseAddress);
        ...
        void Fsmc16BitAccessMode::enable(bool enable) {
        ...
        void Fsmc16BitAccessMode::reset() {
