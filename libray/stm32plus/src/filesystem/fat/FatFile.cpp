    ...
    namespace fat {
        ...
        bool FatFile::read(void *ptr_,uint32_t size_,uint32_t& actuallyRead_) {
            ...
            while(size_ > 0) {
                ...
                if(copySize>10)
                    MEM_DataCopy(current,_sectorBuffer + sectorOffset,copySize);
                else
        ...
        bool FatFile::write(const void *ptr_,uint32_t size_) {
            ...
            if(_offset % sectorSize > 0) {
                ...
                if(amountToCopy>10)
                    MEM_DataCopy(_sectorBuffer + sectorOffset,current,amountToCopy);
                else
            ...
            while(size_ > 0) {
                ...
                if(amountToCopy>10)
                    MEM_DataCopy(_sectorBuffer,current,amountToCopy);
                else
