...
namespace stm32plus {
    ...
    const char *FilenameHandler::getFilename() {
            return _longFilename==NULL ? _shortFilename : _longFilename;
        }
     ...
     */
      ...
      if(_longFilename!=NULL)
                delete [] _longFilename;

      if(_sectorIndices!=NULL)
        delete [] _sectorIndices;

      if(_sectorOffsetIndices!=NULL)
     ...
     */
      ...
      // create new array to hold sector details and store
        ...
        // copy the filename into position
            ...
            dest=_longFilename==NULL ? _shortFilename : _longFilename;
