...
#include "sdcard/device_specific_sd.h"
...
{
// SD_DETECT is optional, we're not doing it here.
...
/**
  ...
  * @param  ReadAddr: Sector Address from where data are to be read.
...
/**
  ...
  * @param  WriteAddr: Sector Address from where data are to be read.
  * @param  BlockSize: the SD card Data block size. The Block size should be 512.
  * @retval SD_Error: SD Card Error code.
  */
...
/**
  ...
  * @param  startaddr: the start sector address.
  * @param  endaddr: the end sector address.
  * @retval SD_Error: SD Card Error code.
  */
...
/**
  ...
  * @retval SD_Error: SD Card Error code.
  */
static SD_Error CmdResp1Error(uint8_t cmd __attribute__((unused)))
{
...
/**
  ...
  * @retval SD_Error: SD Card Error code.
  */
static SD_Error FindSCR(uint16_t rca __attribute__((unused)), uint32_t *pscr)
{
  uint32_t index = 0;
  SD_Error errorstatus = SD_OK;
